...
const CliCmdType CMD_WDT_RELOAD =
	{
		...
		"\tUsage:      smtc <id> wdtr\n",
		"",
		"\tExample:    smtc 0 wdtr; Reload the watchdog timer on Board #0 with the period \n"};
...
const CliCmdType CMD_WDT_SET_PERIOD =
	{
		...
		"\tUsage:	    smtc <id> wdtpwr <val> \n",
		"",
		"\tExample:	   smtc 0 wdtpwr 10; Set the watchdog timer period on Board #0 at 10 seconds \n"};
...
const CliCmdType CMD_WDT_GET_PERIOD =
	{
		...
		"\tUsage:      smtc <id> wdtprd \n",
		"",
		"\tExample:    smtc 0 wdtprd; Get the watchdog timer period on Board #0\n"};
...
const CliCmdType CMD_WDT_SET_INIT_PERIOD =
	{
		...
		"\tUsage:      smtc <id> wdtipwr <val> \n",
		"",
		"\tExample:    smtc 0 wdtipwr 10; Set the watchdog timer initial period on Board #0 at 10 seconds \n"};
...
const CliCmdType CMD_WDT_GET_INIT_PERIOD =
	{
		...
		"\tUsage:      smtc <id> wdtiprd \n",
		"",
		"\tExample:    smtc 0 wdtiprd; Get the watchdog timer initial period on Board #0\n"};
...
const CliCmdType CMD_WDT_SET_OFF_PERIOD =
	{
		...
		"\tUsage:      smtc <id> wdtopwr <val> \n",
		"",
		"\tExample:    smtc 0 wdtopwr 10; Set the watchdog off interval on Board #0 at 10 seconds \n"};
...
const CliCmdType CMD_WDT_GET_OFF_PERIOD =
	{
		...
		"\tUsage:      smtc <id> wdtoprd \n",
		"",
		"\tExample:    smtc 0 wdtoprd; Get the watchdog off period on Board #0\n"};
...
const CliCmdType CMD_WDT_GET_RESETS_COUNT =
	{
		...
		"\tUsage:	    smtc <id> wdtrcrd \n",
		"",
		"\tExample:	    smtc 0 wdtrcrd; Get the watchdog reset count on Board #0\n"};
...
const CliCmdType CMD_WDT_CLR_RESETS_COUNT =
	{
		...
		"\tUsage:	    smtc <id> wdtrcclr\n",
		"",
		"\tExample:	    smtc 0 wdtrcclr -> Clear the watchdog resets count on Board #0\n"};
